...
void PROG_init__(PROG *data__, BOOL retain) {
  __INIT_VAR(data__->PLUS,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->LED,0,retain)
  __INIT_VAR(data__->RESET,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->SETTIME,__time_to_timespec(1, 100, 0, 0, 0, 0),retain)
  __INIT_VAR(data__->COUNTER,0,retain)
  __INIT_VAR(data__->MAXVALUE,255,retain)
...
// Code part
void PROG_body__(PROG *data__) {
  // Initialise TEMP variables

  __SET_VAR(data__->TON0.,IN,,!(__GET_VAR(data__->PLUS,)));
  __SET_VAR(data__->TON0.,PT,,__GET_VAR(data__->SETTIME,));
  TON_body__(&data__->TON0);
  __SET_VAR(data__->TOF0.,EN,,__GET_VAR(data__->TON0.ENO,));
  __SET_VAR(data__->TOF0.,IN,,__GET_VAR(data__->TON0.Q,));
  __SET_VAR(data__->TOF0.,PT,,__GET_VAR(data__->SETTIME,));
  TOF_body__(&data__->TOF0);
  __SET_VAR(data__->,PLUS,,__GET_VAR(data__->TOF0.Q,));
  __SET_VAR(data__->,LED,,__GET_VAR(data__->COUNTER,));
  __SET_VAR(data__->R_TRIG1.,CLK,,__GET_VAR(data__->PLUS,));
  R_TRIG_body__(&data__->R_TRIG1);
  __SET_VAR(data__->CTU0.,CU,,__GET_VAR(data__->R_TRIG1.Q,));
  __SET_VAR(data__->CTU0.,R,,__GET_VAR(data__->RESET,));
  __SET_VAR(data__->CTU0.,PV,,__GET_VAR(data__->MAXVALUE,));
